 ...
 */
package ed.cracken.code.filters;
 ...
 * @author eliud
 */
@WebFilter(filterName = "CrossDomainFilter", urlPatterns = {"/*"}, dispatcherTypes = {DispatcherType.REQUEST, DispatcherType.FORWARD, DispatcherType.ERROR, DispatcherType.INCLUDE})
